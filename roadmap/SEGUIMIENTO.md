...
**Última actualización:** 2026-09-16 (rutina programada de programador, cuarta pasada sin trabajo
...
| R-23 | Cierre de slot en un toque: marcar el resto como presente en bloque | PENDIENTE | 2026-09-16 | Oleada v9 / F-14 · Especificada en el vigésimo tercer ciclo del PM: simétrica a R-17 (que resuelve el cierre en bloque de ausencias) para el caso de una sesión numerosa donde han venido todos. Sin migración: depende de T-18/T-19/T-21 (`COMPLETADA`) y del patrón de UI ya construido por R-17 (`COMPLETADA`) |
