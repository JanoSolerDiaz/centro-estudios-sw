...
export interface ConstructorConsulta<T> {
  ...
  insertar(filas: Record<string, unknown> | readonly Record<string, unknown>[]): Promise<readonly T[]>;
  actualizar(cambios: Record<string, unknown>): Promise<readonly T[]>;
